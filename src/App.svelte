...
<main>
  <!-- tailwind/unocss/attributify works? -->
  <h1 bg="blue-400 hover:blue-500 dark:blue-500 dark:hover:blue-600" text="center" class="mx-auto">Hello {name}!</h1>
  <p>Visit the <a href="https://svelte.dev/tutorial">Svelte tutorial</a>
     to learn how to build Svelte apps.</p>
  <!-- dark mode -->
  <button on:click={toggleDarkMode}>{#if dark}Light{:else}Dark{/if} Mode</button>
  <!-- flowbite works? -->
  <h2>A Flowbite Card!</h2>
